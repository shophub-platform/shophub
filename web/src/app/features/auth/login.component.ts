    ...
    <div class="auth-page">
      <mat-card style="max-width:430px;width:100%">
        <div class="auth-brand">
          ...
          <h2>Welcome back</h2>
          <p class="sh-muted">Sign in to your ShopHub admin panel</p>
        </div>
        ...
        <mat-card-actions align="end">
          <span class="sh-muted">Don't have an account?</span>
...
export class LoginComponent {
  ...
  submit(): void {
    ...
    this.store.dispatch(AuthActions.login({ creds: this.form.getRawValue(), redirect }));
  }
}
